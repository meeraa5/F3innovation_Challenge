...
2. **Enter the Local URL** shown in the terminal (usually `http://localhost:5173/`).
...
1. **Build the project:** This command compiles all files into a static `dist/` folder.  
Bash  
npm run build   
2. **Preview the build:** This starts a small static server to host the contents of the `dist/` folder.  
   Bash  
   npm run preview
